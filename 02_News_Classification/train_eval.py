...
# 权重初始化, 默认Xavier
def init_network(model, method="xavier", exclude="embedding", seed=7):
...
def train(config, model, train_iter, dev_iter, test_iter, writer):
    ...
    # 学习率衰减 每轮epoch lr = gamma * lr
    # scheduler = torch.optim.lr_scheduler.ExponetialLR(optimizer, gamma=0.9)
